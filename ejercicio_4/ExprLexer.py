...
def serializedATN():
    return [
        ...
        0,15,2,1,0,0,0,16,17,5,58,0,0,17,4,1,0,0,0,18,20,7,0,0,0,19,18,1,
        ...
        0,27,8,1,0,0,0,28,29,5,62,0,0,29,10,1,0,0,0,30,32,7,2,0,0,31,30,
...
class ExprLexer(Lexer):
    ...
    ruleNames = [ "IF", "DOTDOBLE", "NUM", "IDT", "MAYOR", "WS" ]
